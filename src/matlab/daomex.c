...
void shm_init(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    {
        mexErrMsgIdAndTxt("MATLAB:myMexFunction:invalidNumArgs", "Invalid number of input or output arguments.");
    }
    ...
    if (nrhs == 2 && !mxIsEmpty(prhs[1]) && mxIsNumeric(prhs[1]))
    {
        ...
        {
            mexErrMsgIdAndTxt("MATLAB:shm_init:invalidNumArgs", "Data type not supported.");
        }
    ...
    else
    {
        ...
        if (newImage == NULL)
        {
            mexErrMsgIdAndTxt("MATLAB:shm_init:memoryAllocationError", "Failed to allocate memory for IMAGE structure.");
        }
        ...
        if (result != DAO_SUCCESS)
        {
            mexErrMsgIdAndTxt("MATLAB:shm_init:daoError", "daoShmShm2Img failed.");
        }
    }
...
void get_data(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    {
        mexErrMsgIdAndTxt("MATLAB:get_data:invalidNumArgs", "Invalid number of input or output arguments.");
    }
    ...
    {
        mexErrMsgIdAndTxt("MATLAB:get_data:noImageSelected", "No IMAGE structure is currently selected. Call 'initImage' first.");
    }
...
void set_data(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    if (nrhs != 2 || nlhs != 0)
    {
        mexErrMsgIdAndTxt("MATLAB:set_data:invalidNumArgs", "Invalid number of input or output arguments.");
    }
    ...
    if (selectedImage == NULL)
    {
        mexErrMsgIdAndTxt("MATLAB:set_data:noImageSelected", "No IMAGE structure is currently selected. Call 'initImage' first.");
    }
...
void get_counter(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    if (nrhs != 1 || nlhs != 1)
    {
        mexErrMsgIdAndTxt("MATLAB:get_counter:invalidNumArgs", "Invalid number of input or output arguments.");
    }
    ...
    if (selectedImage == NULL)
    {
        mexErrMsgIdAndTxt("MATLAB:get_counter:noImageSelected", "No IMAGE structure is currently selected. Call 'initImage' first.");
    }
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    if (nrhs > 0 && mxIsChar(prhs[0]))
    {
        ...
        {
            mexErrMsgIdAndTxt("MATLAB:daomex:unknownFunction", "Unknown function name.");
        }
    ...
    {
        mexErrMsgIdAndTxt("MATLAB:daomex:invalidNumArgs", "Invalid number of input arguments.");
    }
}
