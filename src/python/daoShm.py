...
'''---------------------------------------------------------------------------
Read and write access to shared memory (SHM) structures
This code was developped by SCExAO team
...
dependent on posx_ipc and atropy

The code had been modified by the DAO team to add partial write tools, etc.
'''
