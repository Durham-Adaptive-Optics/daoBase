...
namespace Dao
{
    template<class T> class ShmIfce
    {
        public:
        ...
        inline size_t Size()
        {
            return m_shm_nElements;
        }
        inline size_t GetFrameCounter()
        {
            return m_shm[0].md[0].cnt0;
        }
        inline int32_t GetFrameID()
        {
        ...
        {
            return m_shm[0].md[0].atime.tsfixed.secondlong;
        }
