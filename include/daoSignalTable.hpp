...
namespace Dao
{
    ...
    */
    class SignalTable
    {
        ...
        /**
         * @brief default method for sending a signal. does no checking to see if anyone listening internally it just incriments a volatile
         * signal counter
        ...
        {
            while (tracker[index] >= signal[index])
            {
            } // tracker should never be greater then signal but we use >= incase something bad happens
            tracker[index]++;
        }
