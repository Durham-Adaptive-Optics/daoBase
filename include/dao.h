...
extern "C"
{
    ...
    DLL_EXPORT int_fast8_t daoShmImagePart2Shm(
    ...
    DLL_EXPORT int_fast8_t daoShmImageCreate_FIFO(
        IMAGE* image, const char* name, long naxis, uint32_t* size, uint8_t atype, int shared, int NBkw, uint32_t fifo_size);
    DLL_EXPORT int_fast8_t
    daoShmImageCreate(IMAGE* image, const char* name, long naxis, uint32_t* size, uint8_t atype, int shared, int NBkw);
