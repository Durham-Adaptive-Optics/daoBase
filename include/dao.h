...
DLL_EXPORT int_fast8_t daoShmWaitForSemaphore(IMAGE *image, int32_t semNb,  int32_t timeout);
...
DLL_EXPORT size_t calculateArraySize(uint8_t atype, uint64_t nelement);
DLL_EXPORT size_t calculateBufferSize(IMAGE *image);
DLL_EXPORT int_fast8_t serializeImage(IMAGE *image, char *buffer);
DLL_EXPORT int_fast8_t deserializeImage(char *buffer, IMAGE *image); 
DLL_EXPORT int_fast8_t zmqSendImageTCP(IMAGE *image, void *socket);
DLL_EXPORT int_fast8_t zmqReceiveImageTCP(IMAGE *image, void *socket);
DLL_EXPORT int_fast8_t zmqSendImageUDP(IMAGE *image, void *socket, const char *group, size_t maxPaylod);
DLL_EXPORT int_fast8_t zmqReceiveImageUDP(IMAGE *image, void *socket);
